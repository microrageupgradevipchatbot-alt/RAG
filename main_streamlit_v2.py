...
from rag_utils.vector_store import DOC_DIR, get_gemini_response, DatasetEmptyError, checking_vector_store,get_gemini_response_v2
...
st.set_page_config(page_title="UpgradeVIP RAG Chatbot Version: 2.0", layout="wide")
st.title("UpgradeVIP RAG Chatbot Version: 2.0")
    ...
    if (query and ask) or st.session_state.get("_submitted", False):
        ...
        if query.lower() in ["exit", "quit"]:
            ...
            with st.spinner("Generating answer..."):
                answer = get_gemini_response_v2(query, context, chat_history=recent_history)
